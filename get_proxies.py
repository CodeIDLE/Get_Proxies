...
\ \ \/ ".\ \  \ \  __\   \ \ \____  \ \ \____  \ \ \____  \ \ \/\ \  \ \ \-./\ \  \ \  __\   
 \ \__/".~\_\  \ \_____\  \ \_____\  \ \_____\  \ \_____\  \ \_____\  \ \_\ \ \_\  \ \_____\ 
  \/_/   \/_/   \/_____/   \/_____/   \/_____/   \/_____/   \/_____/   \/_/  \/_/   \/_____/ 
                                                                                                                    """)
    print(Fore.GREEN + fr"                                    Code By CodeIDLE")
    print(Fore.CYAN + fr"=============================================================================================")
...
def bannerW():
    ...
    print(Fore.GREEN + fr"""
  .oooooo.                   .o8            ooooo oooooooooo.   ooooo        oooooooooooo 
 d8P'  `Y8b                 "888            `888' `888'   `Y8b  `888'        `888'     `8 
888           .ooooo.   .oooo888   .ooooo.   888   888      888  888          888         
888          d88' `88b d88' `888  d88' `88b  888   888      888  888          888oooo8    
888          888   888 888   888  888ooo888  888   888      888  888          888    "    
`88b    ooo  888   888 888   888  888    .o  888   888     d88'  888       o  888       o 
 `Y8bood8P'  `Y8bod8P' `Y8bod88P" `Y8bod8P' o888o o888bood8P'   o888ooooood8 o888ooooood8 
                                                                                                                        """)
    print(Fore.CYAN + fr"==========================================================================================")
    print("\n")
